        ...
        <form onSubmit={handleSubmit} style={{ padding: '40px' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <input
                ...
                onFocus={(e) => {
                  ...
                  e.target.style.boxShadow = '0 0 0 3px rgba(122, 105, 144, 0.1)';
                }}
                onBlur={(e) => {
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              >
                <input
                  ...
                  style={getCheckboxStyle(formData.services.includes('cleaning'))}
                />
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              >
                <input
                  ...
                  onChange={(e) => handleCheckboxChange('repairs', e.target.checked)}
                  style={getCheckboxStyle(formData.services.includes('repairs'))}
                />
                <span style={{ fontWeight: '500', color: '#374151' }}>
                  Repairs
                </span>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              >
                <input
                  ...
                  onChange={(e) => handleCheckboxChange('waterproofing', e.target.checked)}
                  style={getCheckboxStyle(formData.services.includes('waterproofing'))}
                />
                <span style={{ fontWeight: '500', color: '#374151' }}>
                  Waterproofing
                </span>
          ...
          <div style={{ textAlign: 'center' }}>
            <button
              ...
              style={{
                backgroundColor: isSubmitting || formData.services.length === 0 ? '#9ca3af' : '#7a6990',
                color: 'white',
                padding: '16px 32px',
                border: 'none',
                borderRadius: '8px',
                fontSize: '1.1rem',
                fontWeight: '600',
                cursor: isSubmitting || formData.services.length === 0 ? 'not-allowed' : 'pointer',
                transition: 'background-color 0.2s'
              }}
              onMouseEnter={(e) => {
