                ...
                <div style={{ display: "flex" }}>
                  ...
                  <div style={{ marginLeft: "12px" }}>
                    ...
                    <div style={{ fontSize: "14px", color: "#fca5a5" }}>
                      <p style={{ margin: 0 }}>
                        {error || getErrorMessage(searchParams.get("error"))}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  >
                    ...
                    >
                      <li style={{ marginBottom: "4px" }}>
                        • Use loveserenespaces@gmail.com and password Spaces123
                      </li>
                      <li style={{ marginBottom: "4px" }}>
                        • Or sign in with Google using
                        loveserenespaces@gmail.com
                      </li>
                      <li style={{ marginBottom: "4px" }}>
                        • Only loveserenespaces@gmail.com is authorized
                      </li>
                      <li style={{ marginBottom: "4px" }}>
                        • If you&apos;re having trouble, try clearing your
                        browser cache
                      </li>
