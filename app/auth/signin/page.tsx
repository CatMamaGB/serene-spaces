              ...
              {showHelp && (
                <div style={{
                  ...
                  <ul style={{
                    ...
                    <li style={{ marginBottom: '4px' }}>• Or sign in with Google using loveserenespaces@gmail.com</li>
                    <li style={{ marginBottom: '4px' }}>• Only loveserenespaces@gmail.com is authorized</li>
